...
fn get_text_block(meta: &PublisherMeta) -> String {
    ...
    temp = meta.get_property_string(EvtPublisherMetadataPublisherGuid).unwrap_or("".to_string());
    message.push_str(
        &format!("GUID: {}\n", temp)
    );
    message.push_str(
    ...
    temp = meta.get_property_string(EvtPublisherMetadataResourceFilePath).unwrap_or("".to_string());
    message.push_str(
        &format!("Resource File Path: {}\n", temp)
    );
    temp = meta.get_property_string(EvtPublisherMetadataParameterFilePath).unwrap_or("".to_string());
    message.push_str(
        &format!("Parameter File Path: {}\n", temp)
    );
    temp = meta.get_property_string(EvtPublisherMetadataMessageFilePath).unwrap_or("".to_string());
    message.push_str(
        &format!("Message File Path: {}\n", temp)
    );
    temp = meta.get_property_string(EvtPublisherMetadataHelpLink).unwrap_or("".to_string());
    message.push_str(
        &format!("Help Link: {}\n", temp)
    );
    temp = match meta.get_publisher_message() {
        ...
        Err(e) => {
            error!("[{}] Error getting publisher message: {}", meta.name, e.message);
            "".to_string()
        }
    };
    message.push_str(
        &format!("Publisher Message: {}\n", temp)
    );
