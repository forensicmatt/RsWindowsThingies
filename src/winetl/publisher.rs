...
impl MetadataTask {
    pub fn new(
        ...
        let name = evt_get_object_array_property(
            &array_handle, i, EvtPublisherMetadataTaskName
        )?.get_variant_value()?;

        let guid = evt_get_object_array_property(
            &array_handle, i, EvtPublisherMetadataTaskEventGuid
        )?.get_variant_value()?;

        let value = evt_get_object_array_property(
            &array_handle, i, EvtPublisherMetadataTaskValue
        )?.get_variant_value()?;
...
impl MetadataLevel {
    pub fn new(
        ...
        )?.get_variant_value().expect("Error EvtPublisherMetadataLevelName");

        let value = evt_get_object_array_property(
            &array_handle, i, EvtPublisherMetadataLevelValue
        )?.get_variant_value().expect("Error EvtPublisherMetadataLevelValue");
        ...
        let message = match message_id {
            0xffffffff => None,
            id => {
                let m = match evt_format_message(
                    Some(&metadata_handle),
                    None,
                    id
                ) {
...
impl MetadataOpcode {
    pub fn new(
        ...
        )?.get_variant_value().expect("Error EvtPublisherMetadataOpcodeName");

        let value = evt_get_object_array_property(
            &array_handle, i, EvtPublisherMetadataOpcodeValue
        )?.get_variant_value().expect("Error EvtPublisherMetadataOpcodeValue");
...
impl MetadataKeyword {
    pub fn new(
        ...
        )?.get_variant_value().expect("Error EvtPublisherMetadataKeywordName");

        let value = evt_get_object_array_property(
            &array_handle, i, EvtPublisherMetadataKeywordValue
        )?.get_variant_value().expect("Error EvtPublisherMetadataKeywordValue");
...
impl PublisherMeta {
    ...
    pub fn get_property(
        ...
        let variant = evt_get_publisher_metadata_property(
            &self.handle, id
        )?;
    ...
    pub fn get_property_string(
        ...
        match variant.get_variant_value() {
            ...
            Err(e) => {
                info!("[{}] Error getting value from varient: {}", self.name, e.message);
                None
            }
        }
    }
        ...
        for (key, id) in &PUBLISHER_METADATA {
            ...
            match id {
                ...
                &EvtPublisherMetadataPublisherMessageID => {
                    ...
                    mapping["EvtPublisherMetadataPublisherMessageID"] = serde_json::to_value(
                        &message
                    )?;
                },
                &EvtPublisherMetadataChannelReferences => {
                ...
                &EvtPublisherMetadataTasks => {
                    ...
                    mapping["EvtPublisherMetadataTasks"] = serde_json::to_value(
                        &meta
                    )?;
                },
                &EvtPublisherMetadataOpcodes => {
                    ...
                    mapping["EvtPublisherMetadataOpcodes"] = serde_json::to_value(
                        &meta
                    )?;
                },
                &EvtPublisherMetadataKeywords => {
                    ...
                    mapping["EvtPublisherMetadataKeywords"] = serde_json::to_value(
                        &meta
                    )?;
                },
                _ => {
